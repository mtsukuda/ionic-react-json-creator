  ...
  data() {
    return {
      ionTags: [
        ...
        { tag: "IonListHeader", label: "IonListHeader" },
        { tag: "IonList", label: "IonList" },
        { tag: "IonItemDivider", label: "IonItemDivider" },
        { tag: "IonItem", label: "IonItem" },
        { tag: "IonIcon", label: "IonIcon", noCR: "yes" },
        { tag: "IonLabel", label: "IonLabel", noCR: "yes" },
